...
const INFO = [
  ...
  { icon: MessageCircle, label: "WhatsApp", value: CONTACT.phone, href: waLink("Hello Vikash Singh Films"), testid: "contact-whatsapp-card" },
...
const EnquiryForm = () => {
  ...
  return (
    <form data-testid="contact-enquiry-form" onSubmit={submit} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
      ...
      <label className="block">
        <span className="block text-[10px] font-mono uppercase tracking-[0.25em] text-slate-500 mb-2">Estimated Budget</span>
      ...
      <label className="block sm:col-span-2">
        ...
        <select data-testid="contact-field-service" value={form.service} onChange={set("service")} className={`${inputCls} bg-[#121215]`}>
